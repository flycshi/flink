 ...
 * 这个是有状态转换函数的核心接口,就是那些维护了跨记录的状态的函数。
 ...
 * 对多个状态类型,存在更多轻量级接口时,这个接口体在管理 <i>keyed state</i> and <i>operator state</i> 时具有最大的弹性。
 *
 ...
 * Shortcuts 说明设置状态函数的轻量级方法常被使用,而不是采用采用具有完整抽象的该接口。
 *
